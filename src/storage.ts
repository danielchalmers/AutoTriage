...
export interface Config {
  ...
  maxFastCommentBodyChars: number;
  maxProCommentBodyChars: number;
  maxFastCommitMessageChars: number;
  maxProCommitMessageChars: number;
  maxFastReviewTextChars: number;
  maxProReviewTextChars: number;
  maxFastPriorThoughtChars: number;
  maxProPriorThoughtChars: number;
  maxTriages: number;
  maxFastRuns: number;
